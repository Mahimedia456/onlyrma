// api/[[...all]].js
// Catch-all serverless API for ALL /api/* routes that aren’t handled
// by the specific files (internal-login.js, viewer-login.js, session.js, logout.js).
// NOTE: This is an in-memory store (resets on cold start).
...
export default async function handler(req, res) {
  ...
  // Anything else under /api that wasn't matched
  return notFound(res);
}
