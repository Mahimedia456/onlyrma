...
export default function RmaStockEmea() {
  ...
  function exportCSV() {
    ...
    const cols = [
      ...
      "awaiting_delivery_from_user","receiving_only","awaiting_return_from_rush",
    ...
    const name = `RMA_EMEA_Stock_${month || "all"}.csv`;
  ...
  return (
    <PageShell>
      ...
      <div className="flex flex-wrap items-end gap-3">
        ...
        <Quick number label="Receiving Only" value={form.receiving_only} onChange={(v) => setForm((f) => ({ ...f, receiving_only: v }))}/>
        ...
        <table className="w-full text-sm">
          ...
          <tbody>
            {loading ? (
              ...
              <tr><td colSpan={10} className="p-6 text-center">No rows</td></tr>
            ) : rows.map((r) => (
